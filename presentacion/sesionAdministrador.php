        ...
        <div class="row vh-100">
            ...
            <nav class="col-lg-3 col-xl-2 d-none d-lg-flex flex-column p-3 text-white" style="background-color: var(--bs-success);">
                ...
                <ul class="nav nav-pills flex-column mb-auto">
                    <li class="nav-item">
                        <a href="crearCuentasCobro.php" class="nav-link text-white">Crear Cuentas de Cobro</a>
                    </li>
                    <li>
                        <a href="consultarCuentasCobro.php" class="nav-link text-white">Consultar Cuentas de Cobro</a>
                    </li>
                    <li>
                        <a href="consultarPropietarios.php" class="nav-link text-white">Consultar Propietarios</a>
                    </li>
                    <li>
                        <a href="consultarApartamentos.php" class="nav-link text-white">Consultar Apartamentos</a>
                    </li>
                </ul>
                <hr class="text-white" />
            ...
            <main class="col-12 col-lg-9 col-xl-10 p-4 bg-light">
                <h2 class="text-success">Panel de Admi
